						...
						<ul class="nav navbar-nav navbar-right" >
							...
							<li>
								<a href="userinfo.jsp" >User Info</a>
                                                       ...
                                                       <li>
								<a href="place.jsp" style=background:white;color:black;" >Places</a>
							</li>
                                                        <li>
...
String q="delete  from PLACE where id=? ";
       ...
       <table align="left" style="width:90%;background: white;"  bgcolor="white">
           <tr>
               <td style="width:10%; padding: 10px; border:4px solid black">Id</td>
                <td style="width:30%; padding: 10px; border:4px solid black"> Name</td>
                <td style="width:30%; padding: 10px; border:4px solid black"> District</td>
                 <td style="width:30%; padding: 10px; border:4px solid black">Caption</td>
           ...
           <%
             ...
             String selectSQL="";
               ...
               selectSQL = "select * from PLACE where district like ?";
...
String mob;
        ...
        while(rs.next())
        {
             ...
             user=rs.getString("caption").toUpperCase();
            
             
           %> <tr>
               <td style="width:10%; padding: 10px; border:1px solid grey"><%=id%></td>
               <td style="width:30%; padding: 10px; border:1px solid grey"><%=name%></td>
      
               <td style="width:30%; padding: 10px; border:1px solid grey"><%=cap%></td>
      
               <td style="width:30%; padding: 10px; border:1px solid grey"><%=user%></td>
