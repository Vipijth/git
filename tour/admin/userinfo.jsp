				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<div class="w3l-navtop" style="width:50%;">
						<ul class="nav navbar-nav navbar-right" >
							...
							<li>
								<a href="userinfo.jsp" style=background:white;color:black;">User Info</a>
							</li>
                                                       <li>
...
String q="delete  from PER_INFO where id=? ";
       ...
       <table align="left" style="width:90%;background: white;"  bgcolor="white">
           <tr>
               <td style="width:10%; padding: 10px; border:1px solid grey">Id</td>
                ...
                <td style="width:20%; padding: 10px; border:1px solid grey"> Last Name</td>
                 <td style="width:20%; padding: 10px; border:1px solid grey">Email</td>
                  <td style="width:20%; padding: 10px; border:1px solid grey">Password</td>
                   <td style="width:20%; padding: 10px; border:1px solid grey">Mobile</td>
                    <td style="width:20%; padding: 10px; border:1px solid grey;background: red;color:white">Remove</td>
           </tr>
           <%
             
              String selectSQL = "select * from per_info";
...
String mob;
        ...
        {
             id=rs.getString("id");
             name=rs.getString("fname").toUpperCase();
             cap=rs.getString("lname").toUpperCase();
             user=rs.getString("email").toUpperCase();
           ...
           %> <tr>
               ...
               <td style="width:20%; padding: 10px; border:1px solid grey"><%=cap%></td>
